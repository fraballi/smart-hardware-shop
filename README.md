...
project build directory and the resources from our **dist/store** generated folder. 
           ...
           <executions>
               <execution>
                   ...
                   <configuration>
                       ...
                       <resources>
                           <resource>
                               <directory>${project.parent.basedir}/frontend/dist/store/</directory>
                           </resource>
                       </resources>
                   </configuration>
               </execution>
...
directory. The **dist/store** folder is used to be placed inside the build output.

```
<resources>
   <resource>
       <directory>./dist/store</directory>
